      ...
      <div className="container section__layout">
        <div className="section__intro">
          ...
          <p>
            ...
            not see your industry represented, reach out—our <a href="#services">services team</a> regularly designs bespoke
        ...
        <div className="section__content section__content--flow">
          ...
          <p className="section__footnote">
            ...
            <a href="#contact"> contact form</a>. We cover project objectives, architecture, governance considerations,
